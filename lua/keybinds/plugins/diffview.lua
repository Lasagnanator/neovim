...
M.view = keys:new({
    ...
    key:new("n", "<Leader>co", actions.conflict_choose("ours"), "Choose the OURS version of a conflict"),
    key:new("n", "<Leader>ct", actions.conflict_choose("theirs"), "Choose the THEIRS version of a conflict"),
    key:new("n", "<Leader>cb", actions.conflict_choose("base"), "Choose the BASE version of a conflict"),
    key:new("n", "<Leader>ca", actions.conflict_choose("all"), "Choose all the versions of a conflict"),
