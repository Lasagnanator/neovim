...
return keys:new({
    key:new("n", "<Leader>fd", function() require("fzf-lua").diagnostics_document() end, "Local diagnostics", silent),
    key:new("n", "<Leader>fD", function() require("fzf-lua").diagnostics_workspace() end, "Workspace diagnostics", silent),
